...
from .models import Activity, ActivitySpeed, ActivityExpense
...
def activity_speed(db):
    speed = ActivitySpeed.objects.create(measure_value=0.5,
...
def activity_speed_factory(db):
    def create_activity_speed(measure_value: float, measure_unit: str, speed_unit=str):
        activity_speed = ActivitySpeed.objects.create(measure_value=measure_value,
...
@pytest.fixture
def activity(db, activity_factory:Activity, activity_speed: ActivitySpeed):
