        ...
        <div class="space-y-4 md:space-x-4 md:space-y-0 md:flex md:justify-between">
            <div class="my-auto">
                <Button color="secondary" icon="add"
                    ...
                    Add Press</Button>
                <RollFedPressMachineModal :is-open="state.createModal.isOpen"
...
export default {
    components: {
        Section, Button, Table, Row, Cell, RollFedPressMachineModal
    },
    setup() {
        ...
        const populateMachines = async ()=> {
            ...
            const response = await RollFedPressMachineApi.listRollFedPressMachines();
            if (response) {
