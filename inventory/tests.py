...
from .models import BaseStockUnit, AlternateStockUnit, Material, Stock
...
def test_material__deposit_stock(db, material: Material):
    stock = material.deposit_stock('Generic', 500, 1000)
